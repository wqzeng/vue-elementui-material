<template>
    <el-dialog :title="title" :visible.sync="dialogVisible" width="30%" :before-close="hideDialog" append-to-body>
        <div class="add">
        ...
        methods: {
            ...
            submit(addForm) {
                this.$refs[addForm].validate(valid => {
                    if (valid) {
                        if(this.formData.id){
                            this.$axios.post("/metadata/item/update", {
                                id: this.formData.id,
                            ...
                            this.$axios.post("/metadata/item/add", {
